...
class UserService {
  ...
  async setBiography(email, bio) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/profile/set_biography/" +
      email;
  ...
  async setProfilePicture(email, profilePicLink) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/profile/set_profilepic/" +
      email;
  ...
  async setFacebook(email, facebookLink) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/profile/set_social_media/" +
      email;
  ...
  async addFriend(myEmail, newEmail) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/friends/add/" +
      myEmail +
      "/" +
      newEmail;
  ...
  async removeFriend(myEmail, newEmail) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/friends/remove/" +
      myEmail +
      "/" +
      newEmail;
  ...
  async getRefreshToken(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/refresh_token/" +
      email;
  ...
  async getName(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/name/" + email;
  ...
  async getAll() {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/users/all";
  ...
  async getUser(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/" + email;
  ...
  async getUserFriends(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/friends/" +
      email;
  ...
  async getUserProfile(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/profile/" + email;
  ...
  async getBiography(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/profile/biography/" +
      email;
  ...
  async getProfilePicture(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/profile/profile_picture/" +
      email;
  ...
  async getFacebook(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/social/facebook/" +
      email;
  ...
  async getInstagram(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/social/instagram/" +
      email;
  ...
  async getTwitter(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/social/twitter/" +
      email;
  ...
  async getTikTok(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/social/tiktok/" +
      email;
  ...
  async getSpotify(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/social/spotify/" +
      email;
  ...
  async getTopArtists(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/stats/top_artists/" +
      email;
  ...
  async getTopGenres(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/stats/top_genres/" +
      email;
  ...
  async getTopTracks(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/stats/top_tracks/" +
      email;
  ...
  async getSpotifyPlaylists(email) {
    ...
    const url =
      "http://localhost:5001/muse-eec76/us-central1/app/api/user/stats/public_playlists/" +
      email;
