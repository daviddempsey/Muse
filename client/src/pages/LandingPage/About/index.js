    ...
    <div className="About" id="about">
      ...
      <div className="text">
        ...
        <div className="row">
          ...
          <p>
            Easy profile setup, Muse integrates seamlessly with Spotify
            <br />
            so that you can showcase all your favorite music with no hassle.
          </p>
        </div>
        <div className="row">
          <img src={MusicNote} alt="music note"></img>
        ...
        <div className="row">
          <img src={MusicNote} alt="music note"></img>
          <p>
            Message and compute musical compatibility with your friends
            <br />
            directly through Muse.
          </p>
        </div>
      </div>
    </div>
